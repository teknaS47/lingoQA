...
ActiveRecord::Schema.define(version: 2021_08_24_094457) do
  ...
  create_table "bugzilla_product_names", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "name"
  end
  ...
  create_table "product_versions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "product_id"
    t.bigint "bugzilla_product_names_id" null: true
    t.index ["bugzilla_product_names_id"], name: "index_product_versions_on_bugzilla_product_names_id" null: true
